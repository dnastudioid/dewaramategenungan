              ...
              <tbody>
                ...
                @foreach ($articles as $article)
                    <tr>
                        ...
                        <td><center> <button class="btn btn-sm btn-success" onClick="showImage('{{$article->cover}}');">Lihat Cover</button></center></td>
...
@section('js')
    ...
    function showImage(cover){
      bootbox.dialog({
        message: '<img src="{{asset('backend/images/article')}}/'+cover+'" class="img-responsive">',
        closeButton: true,
        size: 'small'
      });
    }
